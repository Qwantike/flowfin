...
export const AssetList: React.FC<AssetListProps> = ({ assets, onRemove }) => {
  ...
  if (assets.length === 0) return (
    <div className="bg-slate-800/30 backdrop-blur-md rounded-xl p-8 border border-slate-700/50 text-center">
      <p className="text-slate-500">Aucun autre actif renseigné.</p>
    </div>
  );
